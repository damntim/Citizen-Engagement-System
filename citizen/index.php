            ...
            <div class="container mx-auto px-4">
                <div class="flex justify-between items-center py-4">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <!-- Track Status Button -->
                        <button class="bg-rwandan-yellow text-white px-3 py-2 rounded-full text-sm font-medium shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition duration-300 hidden md:flex items-center space-x-1 whitespace-nowrap">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
