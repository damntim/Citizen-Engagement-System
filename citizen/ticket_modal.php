                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <select id="institution" name="institution" required class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-rwandan-green focus:border-rwandan-green sm:text-sm">
                                    ...
                                    <option value="mineduc">Ministry of Education (MINEDUC)</option>
                                    <option value="mininfra">Ministry of Infrastructure (MININFRA)</option>
                                    <option value="minagri">Ministry of Agriculture (MINAGRI)</option>
                                    <option value="moh">Ministry of Health (MOH)</option>
                                    <option value="rra">Rwanda Revenue Authority (RRA)</option>
                                    <option value="rdb">Rwanda Development Board (RDB)</option>
                                    <option value="wasac">Water and Sanitation Corporation (WASAC)</option>
                                    <option value="reg">Rwanda Energy Group (REG)</option>
                                    <option value="rssb">Rwanda Social Security Board (RSSB)</option>
                                    <option value="district">District Administration</option>
                                    <option value="sector">Sector Administration</option>
                                    <option value="police">Rwanda National Police</option>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Load services based on institution
    function loadServices(institution) {
        ...
        // Here you would normally fetch services from the server based on the institution
        // For now, we'll add some dummy services
        if (institution === 'mineduc') {
            addServiceOption('school_registration', 'School Registration');
            addServiceOption('certificate', 'Certificate Issuance');
            addServiceOption('scholarship', 'Scholarship Application');
        } else if (institution === 'mininfra') {
            addServiceOption('road_maintenance', 'Road Maintenance');
            addServiceOption('water_supply', 'Water Supply');
            addServiceOption('electricity', 'Electricity Connection');
        } else if (institution === 'rra') {
            addServiceOption('tax_filing', 'Tax Filing');
            addServiceOption('tax_clearance', 'Tax Clearance Certificate');
            addServiceOption('tin_registration', 'TIN Registration');
        }
